...
bobj.crv.params.newParameterPanelToolbar = function(kwArgs) {
    ...
    o.delButton = newIconWidget( 
        o.id + '_delBtn',        
        bobj.crvUri('images/delete.gif'),   
        bind(o._onDelClick, o), //clickCB,   
        L_bobj_crv_ParamsDelete,//text,      
        L_bobj_crv_ParamsDelete,//tooltip,   
        16, 16, 3, 3, 25, 3);   //width, height, dx, dy, disDx, disDy     
        
    o.applyButton = newIconWidget( 
        o.id + '_applyBtn',        
        bobj.crvUri('images/param_run.gif'),    
...
bobj.crv.params.newParameterTab = function(kwArgs) {
    ...
    o.addIcon(bobj.crvUri('images/param_dirty.gif'), L_bobj_crv_ParamsDirtyTip, false, o._isDirtyInit, o._dirtyId);
    ...
    if(kwArgs.minMaxTooltip || kwArgs.isReadOnly) {
        ...
        o.addIcon(bobj.crvUri('images/param_info.gif'),tooltip, false, true, o.id + '_icnInfo');
    }
    
    if (o.isDataFetching) {
        o.addIcon(bobj.crvUri('images/param_datafetching.gif'), L_bobj_crv_ParamsDataTip, true, true, null);
    }
