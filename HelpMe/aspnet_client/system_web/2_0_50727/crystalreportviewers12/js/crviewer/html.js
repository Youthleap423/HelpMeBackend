...
bobj.html.openTag = function(tag, atts) {
    ...
    for (var i in atts) {
        if (i in Object.prototype) { continue; } // in case Object was extended
        ...
        if (bobj.isArray(value)) {
            ...
            var stringValue = ""
            for (var k in value) {
                if (k in Object.prototype) { continue; }
...
bobj.html.extractHtml = function(html) {
    ...
    var extHtml = extScripts.html;
    var extLinks = bobj.html.extractLinks(extHtml);
    
    return {scripts: extScripts.scripts, html : extLinks.html, links : extLinks.links};
}
