<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" AutoEventWireup="true" CodeBehind="Amenity.aspx.cs" Inherits="RentTrack.Amenity" %>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        <i class="fa fa-th-large"></i><span>Amenity Master</span>
                    </div>
                    <div class="box-icons">
                    ...
                    <form id="defaultForm" method="post" class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <asp:DropDownList ID="ddlAmenityType" runat="server" ValidationGroup="Amenity" CssClass="form-control">
                                        <asp:ListItem Selected="True" Text="--Select Amenity Type--" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Internal" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="External" Value="2"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="col-sm-1">
                                    <asp:RequiredFieldValidator ID="reqAmenityType" runat="server" ForeColor="Red" ControlToValidate="ddlAmenityType"
