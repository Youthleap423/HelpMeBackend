<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" AutoEventWireup="true" CodeBehind="Tenant.aspx.cs" Inherits="RentTrack.Tenant" %>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        <i class="fa fa-th-large"></i><span>Tenant Master</span>
                    </div>
                    <div class="box-icons">
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">
                                            Tenant Type :<span style="color: Red"> *</span></label>
                                        <div class="col-sm-4">
                                            <asp:DropDownList ID="ddlTenantType" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlTenantType_SelectedIndexChanged" AutoPostBack="true">
                                        ...
                                        <div class="col-sm-1">
                                            <asp:RequiredFieldValidator ID="Req_TenantType" runat="server" ControlToValidate="ddlTenantType"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <asp:DropDownList ID="ddlPaymentMode" runat="server" CssClass="form-control">
                                                <asp:ListItem Text="--Select Payment mode--" Value="0" Selected="True"></asp:ListItem>
                                        ...
                                        <div class="col-sm-1">
                                            <asp:RequiredFieldValidator ID="req_PaymentMode" runat="server" ControlToValidate="ddlPaymentMode"
                                                Display="Static" ErrorMessage="***" InitialValue="0" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="clearfix">
                                    ...
                                    <div id="divPersonalDetails" runat="server" visible="true">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <asp:HiddenField ID="hfTenantDetailsLrNo" runat="server" Value="" />
                                                <asp:Button ID="btnAddTenantDetails" Text="Add" ValidationGroup="PersonalDetailType" runat="server" CssClass="btn btn-primary btn-label-left" OnClick="btnAddTenantDetails_Click" />
                                                <asp:Button ID="btnClearTenantDetails" CausesValidation="false" Text="Clear" runat="server" CssClass="btn btn-warning btn-label-left" OnClick="btnClearTenantDetails_Click" />
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                        <div class="form-group" id="MessageTenantDetailsSection" runat="server" visible="false">
                                            <div class="col-sm-12">
                                                <asp:Label ID="MessageTenantDetails" runat="server" CssClass="form-control" ViewStateMode="Disabled"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                        <div class="form-group">
                                            <asp:Repeater ID="rptTenantDetailsData" runat="server" OnItemCommand="rptTenantDetailsData_ItemCommand">
                                                <HeaderTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <tr class="repeaterrow">
                                                        ...
                                                        <td style="padding-left: 5px; text-align: left; width: 45%">
                                                            ...
                                                            <asp:HiddenField ID="hfTenantDetailsId" Value='<%# Eval("TenantDetailsId") %>' runat="server" />
                                                            <asp:HiddenField ID="hfPersonalDetailTypeId" Value='<%# Eval("PersonalDetailTypeId") %>' runat="server" />
                                                            <asp:HiddenField ID="hfTenantDetailsLrNo" Value='<%# Eval("iLrNo") %>' runat="server" />
                                                        </td>
                                    ...
                                    <div id="divCompanyDetails" runat="server" visible="false">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <asp:HiddenField ID="hfTenantCompanyDetailsLrNo" runat="server" Value="" />
                                                <asp:Button ID="btnAddTenantCompanyDetails" Text="Add" ValidationGroup="CompanyPersonalDetailType" runat="server" CssClass="btn btn-primary btn-label-left" OnClick="btnAddTenantCompanyDetails_Click" />
                                                <asp:Button ID="btnClearTenantCompanyDetails" CausesValidation="false" Text="Clear" runat="server" CssClass="btn btn-warning btn-label-left" OnClick="btnClearTenantCompanyDetails_Click" />
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                        <div class="form-group" id="MessageTenantCompanyDetailsSection" runat="server" visible="false">
                                            <div class="col-sm-12">
                                                <asp:Label ID="MessageTenantCompanyDetails" runat="server" CssClass="form-control" ViewStateMode="Disabled"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                        <div class="form-group">
                                            <asp:Repeater ID="rptTenantCompanyDetailsData" runat="server" OnItemCommand="rptTenantCompanyDetailsData_ItemCommand">
                                                <HeaderTemplate>
                                                    <table cellpadding="0" cellspacing="0" width="100%" border="0" style="text-align: center;">
                                                        <tr class="repeaterheader">
                                                            <td style="text-align: center; width: 5%"><b>No.</b>
                                                ...
                                                <ItemTemplate>
                                                    <tr class="repeaterrow">
                                                        ...
                                                        <td style="padding-left: 5px; text-align: left; width: 45%">
                                                            <asp:Label ID="lblPersonalDetailType" Text='<%# Eval("PersonalDetailTypeName") %>' runat="server"></asp:Label>
                                                            <asp:HiddenField ID="hfTenantCompanyDetailsId" Value='<%# Eval("TenantCompanyDetailsId") %>' runat="server" />
                                                            <asp:HiddenField ID="hfPersonalDetailTypeId" Value='<%# Eval("PersonalDetailTypeId") %>' runat="server" />
                                                            <asp:HiddenField ID="hfTenantCompanyDetailsLrNo" Value='<%# Eval("iLrNo") %>' runat="server" />
                                                        </td>
                                                        <td style="padding-left: 5px; text-align: left; width: 30%">
                                                            <asp:Label ID="lblPersonalDetailValue" runat="server" Text='<%# Eval("PersonalDetailValue") %>'></asp:Label>
                                                        </td>
