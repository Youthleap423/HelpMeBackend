<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" AutoEventWireup="true" CodeBehind="State.aspx.cs" Inherits="RentTrack.State" %>
        ...
        <div id="pnl_add" runat="server" class="col-xs-12 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        <i class="fa fa-th-large"></i><span>State/County Master</span>
                    </div>
                    <div class="box-icons">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1">
                                    <asp:RequiredFieldValidator ID="reqGroup" runat="server" ControlToValidate="ddlGroup"
                                        Display="Static" InitialValue="0" ErrorMessage="***" ForeColor="Red"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="clearfix">
                            </div>
