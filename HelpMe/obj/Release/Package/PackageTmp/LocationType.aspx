<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" AutoEventWireup="true" CodeBehind="LocationType.aspx.cs" Inherits="RentTrack.LocationType" %>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        <i class="fa fa-th-large"></i><span>Location Type</span>
                    </div>
                    <div class="box-icons">
                ...
                <div class="box-content">
                    <form id="defaultForm" method="post" class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">
                                    Data pick from : </label>
                                <div class="col-sm-4">
                                    <asp:DropDownList ID="ddlGroup1" runat="server" CssClass="form-control">
                                        <asp:ListItem Text="--No Selection--" Value="0" Selected="True"></asp:ListItem>
                                        <asp:ListItem Text="Country" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="State/County" Value="2"></asp:ListItem>
                                        <asp:ListItem Text="City" Value="3"></asp:ListItem>
                                        <asp:ListItem Text="Zone/Town" Value="4"></asp:ListItem>
