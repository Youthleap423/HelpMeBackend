<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" AutoEventWireup="true" CodeBehind="PaymentStatus.aspx.cs" Inherits="RentTrack.PaymentStatus" %>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        <i class="fa fa-th-large"></i><span id="TitleCaption" runat="server">Invoice Payment</span>
                    </div>
                    <div class="box-icons">
