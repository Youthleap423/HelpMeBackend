<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" AutoEventWireup="true" CodeBehind="BuildingParameter.aspx.cs" Inherits="RentTrack.BuildingParameter" %>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        <i class="fa fa-th-large"></i><span>Building Parameter</span>
                    </div>
                    <div class="box-icons">
