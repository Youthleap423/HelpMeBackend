<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" AutoEventWireup="true" CodeBehind="Landlord.aspx.cs" Inherits="RentTrack.Landlord" %>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        <i class="fa fa-th-large"></i><span>Landlord Master</span>
                    </div>
                    <div class="box-icons">
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">
                                            Landlord Type :<span style="color: Red"> *</span></label>
                                        <div class="col-sm-4">
                                            <asp:DropDownList ID="ddlLandlordType" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlLandlordType_SelectedIndexChanged" AutoPostBack="true">
                                        ...
                                        <div class="col-sm-1">
                                            <asp:RequiredFieldValidator ID="Req_LandlordType" runat="server" ControlToValidate="ddlLandlordType"
                                    ...
                                    <div id="divPersonalDetails" runat="server" visible="true">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <asp:HiddenField ID="hfLandlordDetailsLrNo" runat="server" Value="" />
                                                <asp:Button ID="btnAddLandlordDetails" Text="Add" ValidationGroup="PersonalDetailType" runat="server" CssClass="btn btn-primary btn-label-left" OnClick="btnAddLandlordDetails_Click" />
                                                <asp:Button ID="btnClearLandlordDetails" CausesValidation="false" Text="Clear" runat="server" CssClass="btn btn-warning btn-label-left" OnClick="btnClearLandlordDetails_Click" />
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                        <div class="form-group" id="MessageLandlordDetailsSection" runat="server" visible="false">
                                            <div class="col-sm-12">
                                                <asp:Label ID="MessageLandlordDetails" runat="server" CssClass="form-control" ViewStateMode="Disabled"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                        <div class="form-group">
                                            <asp:Repeater ID="rptLandlordDetailsData" runat="server" OnItemCommand="rptLandlordDetailsData_ItemCommand">
                                                <HeaderTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <tr class="repeaterrow">
                                                        ...
                                                        <td style="padding-left: 5px; text-align: left; width: 45%">
                                                            ...
                                                            <asp:HiddenField ID="hfLandlordDetailsId" Value='<%# Eval("LandlordDetailsId") %>' runat="server" />
                                                            <asp:HiddenField ID="hfPersonalDetailTypeId" Value='<%# Eval("PersonalDetailTypeId") %>' runat="server" />
                                                            <asp:HiddenField ID="hfLandlordDetailsLrNo" Value='<%# Eval("iLrNo") %>' runat="server" />
                                                        </td>
                                    ...
                                    <div id="divCompanyDetails" runat="server" visible="false">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <asp:HiddenField ID="hfLandlordCompanyDetailsLrNo" runat="server" Value="" />
                                                <asp:Button ID="btnAddLandlordCompanyDetails" Text="Add" ValidationGroup="CompanyPersonalDetailType" runat="server" CssClass="btn btn-primary btn-label-left" OnClick="btnAddLandlordCompanyDetails_Click" />
                                                <asp:Button ID="btnClearLandlordCompanyDetails" CausesValidation="false" Text="Clear" runat="server" CssClass="btn btn-warning btn-label-left" OnClick="btnClearLandlordCompanyDetails_Click" />
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                        <div class="form-group" id="MessageLandlordCompanyDetailsSection" runat="server" visible="false">
                                            <div class="col-sm-12">
                                                <asp:Label ID="MessageLandlordCompanyDetails" runat="server" CssClass="form-control" ViewStateMode="Disabled"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="clearfix">
                                        </div>
                                        <div class="form-group">
                                            <asp:Repeater ID="rptLandlordCompanyDetailsData" runat="server" OnItemCommand="rptLandlordCompanyDetailsData_ItemCommand">
                                                <HeaderTemplate>
                                                    <table cellpadding="0" cellspacing="0" width="100%" border="0" style="text-align: center;">
                                                        <tr class="repeaterheader">
                                                            <td style="text-align: center; width: 5%"><b>No.</b>
                                                ...
                                                <ItemTemplate>
                                                    <tr class="repeaterrow">
                                                        ...
                                                        <td style="padding-left: 5px; text-align: left; width: 45%">
                                                            <asp:Label ID="lblPersonalDetailType" Text='<%# Eval("PersonalDetailTypeName") %>' runat="server"></asp:Label>
                                                            <asp:HiddenField ID="hfLandlordCompanyDetailsId" Value='<%# Eval("LandlordCompanyDetailsId") %>' runat="server" />
                                                            <asp:HiddenField ID="hfPersonalDetailTypeId" Value='<%# Eval("PersonalDetailTypeId") %>' runat="server" />
                                                            <asp:HiddenField ID="hfLandlordCompanyDetailsLrNo" Value='<%# Eval("iLrNo") %>' runat="server" />
                                                        </td>
                                                        <td style="padding-left: 5px; text-align: left; width: 30%">
                                                            <asp:Label ID="lblPersonalDetailValue" runat="server" Text='<%# Eval("PersonalDetailValue") %>'></asp:Label>
                                                        </td>
