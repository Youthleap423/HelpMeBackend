<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" AutoEventWireup="true" CodeBehind="MaintenanceStatus.aspx.cs" Inherits="RentTrack.MaintenanceStatus" %>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        <i class="fa fa-th-large"></i><span>Maintenance Status</span>
                    </div>
                    <div class="box-icons">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">
                                    Maintenance Status : <span style="color: Red">*</span></label>
                                <div class="col-sm-4">
