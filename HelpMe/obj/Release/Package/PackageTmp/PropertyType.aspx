<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" AutoEventWireup="true" CodeBehind="PropertyType.aspx.cs" Inherits="RentTrack.PropertyType" %>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        <i class="fa fa-th-large"></i><span>Property Type</span>
                    </div>
                    <div class="box-icons">
                    ...
                    <form id="defaultForm" method="post" class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <asp:CheckBoxList ID="cbCharge" runat="server" RepeatDirection="Horizontal" RepeatColumns="2">
                                    </asp:CheckBoxList>
                                </div>
                                <div class="col-sm-1">
                                    &nbsp;
