<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" AutoEventWireup="true" CodeBehind="Broker.aspx.cs" Inherits="RentTrack.Broker" ValidateRequest="false" %>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        <i class="fa fa-th-large"></i><span>Broker Master</span>
                    </div>
                    <div class="box-icons">
                    ...
                    <asp:UpdatePanel ID="uppanle" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <asp:DropDownList ID="ddlBrokerType" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlBrokerType_SelectedIndexChanged" AutoPostBack="true">
                                ...
                                <div class="col-sm-1">
                                    <asp:RequiredFieldValidator ID="Req_BrokerType" runat="server" ControlToValidate="ddlBrokerType"
                            ...
                            <div id="divPersonalDetails" runat="server" visible="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:HiddenField ID="hfBrokerDetailsLrNo" runat="server" Value="" />
                                        <asp:Button ID="btnAddBrokerDetails" Text="Add" ValidationGroup="PersonalDetailType" runat="server" CssClass="btn btn-primary btn-label-left" OnClick="btnAddBrokerDetails_Click" />
                                        <asp:Button ID="btnClearBrokerDetails" CausesValidation="false" Text="Clear" runat="server" CssClass="btn btn-warning btn-label-left" OnClick="btnClearBrokerDetails_Click" />
                                    </div>
                                </div>
                                <div class="clearfix">
                                </div>
                                <div class="form-group" id="MessageBrokerDetailsSection" runat="server" visible="false">
                                    <div class="col-sm-12">
                                        <asp:Label ID="MessageBrokerDetails" runat="server" CssClass="form-control" ViewStateMode="Disabled"></asp:Label>
                                    </div>
                                </div>
                                <div class="clearfix">
                                </div>
                                <div class="form-group">
                                    <asp:Repeater ID="rptBrokerDetailsData" runat="server" OnItemCommand="rptBrokerDetailsData_ItemCommand">
                                        <HeaderTemplate>
                                        ...
                                        <ItemTemplate>
                                            <tr class="repeaterrow">
                                                ...
                                                <td style="padding-left: 5px; text-align: left; width: 45%">
                                                    ...
                                                    <asp:HiddenField ID="hfBrokerDetailsId" Value='<%# Eval("BrokerDetailsId") %>' runat="server" />
                                                    <asp:HiddenField ID="hfPersonalDetailTypeId" Value='<%# Eval("PersonalDetailTypeId") %>' runat="server" />
                                                    <asp:HiddenField ID="hfBrokerDetailsLrNo" Value='<%# Eval("iLrNo") %>' runat="server" />
                                                </td>
                            ...
                            <div id="divCompanyDetails" runat="server" visible="false">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:HiddenField ID="hfBrokerCompanyDetailsLrNo" runat="server" Value="" />
                                        <asp:Button ID="btnAddBrokerCompanyDetails" Text="Add" ValidationGroup="CompanyPersonalDetailType" runat="server" CssClass="btn btn-primary btn-label-left" OnClick="btnAddBrokerCompanyDetails_Click" />
                                        <asp:Button ID="btnClearBrokerCompanyDetails" CausesValidation="false" Text="Clear" runat="server" CssClass="btn btn-warning btn-label-left" OnClick="btnClearBrokerCompanyDetails_Click" />
                                    </div>
                                </div>
                                <div class="clearfix">
                                </div>
                                <div class="form-group" id="MessageBrokerCompanyDetailsSection" runat="server" visible="false">
                                    <div class="col-sm-12">
                                        <asp:Label ID="MessageBrokerCompanyDetails" runat="server" CssClass="form-control" ViewStateMode="Disabled"></asp:Label>
                                    </div>
                                </div>
                                <div class="clearfix">
                                </div>
                                <div class="form-group">
                                    <asp:Repeater ID="rptBrokerCompanyDetailsData" runat="server" OnItemCommand="rptBrokerCompanyDetailsData_ItemCommand">
                                        <HeaderTemplate>
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0" style="text-align: center;">
                                                <tr class="repeaterheader">
                                                    <td style="text-align: center; width: 5%"><b>No.</b>
                                        ...
                                        <ItemTemplate>
                                            <tr class="repeaterrow">
                                                ...
                                                <td style="padding-left: 5px; text-align: left; width: 45%">
                                                    <asp:Label ID="lblPersonalDetailType" Text='<%# Eval("PersonalDetailTypeName") %>' runat="server"></asp:Label>
                                                    <asp:HiddenField ID="hfBrokerCompanyDetailsId" Value='<%# Eval("BrokerCompanyDetailsId") %>' runat="server" />
                                                    <asp:HiddenField ID="hfPersonalDetailTypeId" Value='<%# Eval("PersonalDetailTypeId") %>' runat="server" />
                                                    <asp:HiddenField ID="hfBrokerCompanyDetailsLrNo" Value='<%# Eval("iLrNo") %>' runat="server" />
                                                </td>
                                                <td style="padding-left: 5px; text-align: left; width: 30%">
                                                    <asp:Label ID="lblPersonalDetailValue" runat="server" Text='<%# Eval("PersonalDetailValue") %>'></asp:Label>
                                                </td>
