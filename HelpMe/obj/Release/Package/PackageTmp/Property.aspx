<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="Property.aspx.cs" Inherits="RentTrack.Property" %>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <asp:DropDownList ID="ddlChargeMode" runat="server" ValidationGroup="Charge" CssClass="form-control">
                                                <asp:ListItem Selected="True" Text="--Select Payment Mode--" Value="0"></asp:ListItem>
