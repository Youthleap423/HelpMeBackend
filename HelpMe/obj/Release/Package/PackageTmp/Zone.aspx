<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" AutoEventWireup="true" CodeBehind="Zone.aspx.cs" Inherits="RentTrack.Zone" %>
        ...
        <div id="pnl_add" runat="server" class="col-xs-12 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        <i class="fa fa-th-large"></i><span>Zone/Town Master</span>
                    </div>
                    <div class="box-icons">
                            ...
                            <asp:UpdatePanel ID="upUserType" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <asp:RequiredFieldValidator ID="reqGroup1" runat="server" ControlToValidate="ddlGroup1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <asp:DropDownList ID="ddlGroup2" runat="server" CssClass="form-control">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-sm-1">
                                            <asp:RequiredFieldValidator ID="reqGroup2" runat="server" ControlToValidate="ddlGroup2"
                                                ForeColor="Red" Display="Static" InitialValue="0" ErrorMessage="***"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="clearfix">
