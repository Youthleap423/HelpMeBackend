<%@ Page Title="" Language="C#" MasterPageFile="~/SiteLinks.Master" AutoEventWireup="true" CodeBehind="Charge.aspx.cs" Inherits="RentTrack.Charge" %>
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-name">
                        <i class="fa fa-th-large"></i><span>Charge Master</span>
                    </div>
                    <div class="box-icons">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">
                                    Charge : <span style="color: Red">*</span></label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">
                                    Property Type : </label>
                                <div class="col-sm-4">
                                    <asp:CheckBoxList ID="cbPropertyType" runat="server" RepeatDirection="Horizontal" RepeatColumns="2">
                                    </asp:CheckBoxList>
                                </div>
                                <div class="col-sm-1">
                                    &nbsp;
